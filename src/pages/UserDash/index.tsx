...
export const UserDash = () => {
    ...
    return (
        <StyledUserDash>
            <header>Inserir componente</header>
            ...
            <StyledContainer flex={true} className="container">
                <section className="donations-history">
                    ...
                    <ul className="ul-mobile">
                        ...
                        <HistoryCard name={"Zico"} value={160} img={"https://www.algosobre.com.br/images/stories/assuntos/biografias/Zico.jpg"}/>
                    </ul>
                    <ul className="ul-desktop">
                        <AthleteCard athlete_id="1" img={"https://www.algosobre.com.br/images/stories/assuntos/biografias/Zico.jpg"} name="Zico" age={18} city="Santos"/>
                        <AthleteCard athlete_id="1" img="undefined" name="Pelé" age={18} city="Santos"/>
                        <AthleteCard athlete_id="1" img="undefined" name="Pelé" age={18} city="Santos"/>                        
                    </ul>
                </section>
                <section className="render-buttons">
